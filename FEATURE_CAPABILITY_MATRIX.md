...
| Raw two-output Bit Banger | Loopback | Standalone FPGA Bit Banger | Preview and analysis | 1024-symbol FIFO; open-drain readback is host-emulated. |
...
| Filtering, thresholds, spectrum, spectrogram, correlation | Yes | Yes on available analog data | Yes | Derived channels never replace raw samples. |
| Reports and exports | Yes | Yes | No | JSON, CSV, VCD, NPZ, HTML report. |
