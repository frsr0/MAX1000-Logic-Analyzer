...
- `seed 5` is the current best corrected-RTL placement after the 2026-07-21
  analog-packer timing fix; it currently misses `fast_clk` setup by 0.107 ns, so rerun the
