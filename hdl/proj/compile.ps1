...
$qsfLines = @(
    ...
    'set_global_assignment -name OPTIMIZATION_TECHNIQUE SPEED -entity Fast_Logic_Analyzer_SDRAM',
    ...
    'set_instance_assignment -name OPTIMIZATION_TECHNIQUE SPEED -to "|OLS_SDRAM_Top:core|OLS_Logic_Analyzer:SDRAM_Analyzer|Fast_Logic_Analyzer_SDRAM:Fast_Logic_Analyzer_SDRAM1"',
    ...
    'set_global_assignment -name VHDL_FILE ../rtl/Generic_Pattern_Trigger.vhd',
    ...
    '',
    '# Weak pull-ups on all MKR digital inputs and sensor-bus pins',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[0]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[1]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[2]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[3]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[4]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[5]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[6]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[7]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[8]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[9]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[10]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[11]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[12]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[13]',
    'set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to MKR_D[14]',
