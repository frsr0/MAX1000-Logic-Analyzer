...
report_timing -setup -from_clock [get_clocks SDRAM_CHIP_CLK_OUT] -to_clock [get_clocks sdram_core_clk] -npaths 10 -detail full_path -file postfix_sdram_to_clk2.rpt
report_timing -setup -from_clock [get_clocks sdram_core_clk] -to_clock [get_clocks SDRAM_CHIP_CLK_OUT] -npaths 10 -detail full_path -file postfix_clk2_to_sdram.rpt
