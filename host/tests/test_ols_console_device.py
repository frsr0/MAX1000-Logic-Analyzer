...
from app.OLS_Console import OLSDevice, CMD_RESET, CMD_ID, CMD_GEN_STRT, CMD_GEN_PINS
from app.OLS_Console import CMD_METADATA, CMD_XON, CMD_XOFF, CMD_DIVIDER, CMD_RCOUNT
...
class TestOLSDeviceInit:
    ...
    @patch('app.OLS_Console.find_port')
    @patch('app.OLS_Console.serial.Serial')
