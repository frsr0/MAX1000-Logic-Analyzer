...
from OLS_Console import OLScope, WaveformDisplay, NUM_CHANNELS
from OLS_Console import ANALOG_MODE_DIGITAL8, ANALOG_MODE_MIXED1, ANALOG_MODE_MIXED2
from OLS_Console import ANALOG_MODE_ANALOG1, ANALOG_MODE_ANALOG2
